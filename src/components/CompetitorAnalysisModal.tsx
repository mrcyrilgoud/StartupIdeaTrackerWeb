...
<body>
    ...
    return (
        <div className="fixed inset-0 bg-black/70 flex justify-center items-center z-[1000] p-5">
            <div className="bg-surface rounded-2xl w-full max-w-[800px] max-h-[90vh] flex flex-col shadow-[0_20px_60px_rgba(0,0,0,0.4)]">
                {/* Header */}
                <div className="p-6 border-b border-border flex justify-between items-center">
                    <div className="flex items-center gap-3">
                        <div className="bg-[#ff3b301a] p-2 rounded-lg text-[#ff3b30]">
                            <Swords size={24} />
                        </div>
                        <div>
                            <h2 className="m-0 text-xl font-bold">Competitor Analysis</h2>
                ...
                <div className="flex-1 overflow-y-auto p-6">
                    {loading ? (
                        <div className="flex flex-col items-center justify-center py-16 px-5 text-text-secondary">
                            <div className="w-12 h-12 border-[3px] border-border border-t-[#ff3b30] rounded-full animate-spin mb-4" />
                            <p className="m-0 text-base">Identifying competitors...</p>
                            <p className="mt-2 text-sm opacity-70">
                                Scouring the market landscape for threats and opportunities
                            </p>
                            <p className="mt-4 text-xs text-[#ff3b30] bg-[#ff3b301a] px-4 py-2 rounded-lg">
